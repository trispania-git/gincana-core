...
define('GINCANA_CORE_VERSION', '1.0.108');
...
require_once GINCANA_CORE_PATH . 'includes/theme.php';
require_once GINCANA_CORE_PATH . 'includes/sopa-letras.php';
...
require_once GINCANA_CORE_PATH . 'includes/admin-media-fields.php';
...
require_once GINCANA_CORE_PATH . 'includes/metabox-prueba.php';
